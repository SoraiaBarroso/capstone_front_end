    ...
    return (
            <section className='flex lg:px-20 2xl:px-56 2xl:h-[25em] sm:px-8 h-96 text-white bg-primary-green' id='home'>
                <div className="h-full m-0 w-1/2">
                    <h1 className='text-primary-yellow font-serif md:font-bold mt-10 2xl:text-5xl md:text-4xl sm:text-4xl'>Little Lemon</h1>
                    <h2 className='mt-2 2xl:text-2xl sm:text-lg font-medium'>Chicago</h2>
                    <p className='2xl:w-3/4 lg:text-lg md:text-lg 2xl:text-lg sm:w-full 2xl:text-md sm:text-sm mt-6'>
                ...
                <div className="w-1/2 m-0 h-full flex justify-end items-center">
                    <img className="2xl:mt-40 lg:mt-24 lg:h-[24em] 2xl:h-[28em] sm:w-[16em] sm:h-[20em] 2xl:w-[28em] md:w-[20em] object-cover rounded-lg" src={dish} alt="main"/>
                </div>
            </section>
    );
}
