        ...
        <>
            <section className='flex 2xl:px-48 sm:px-12 h-96 text-white bg-primary-green'>
                <div className="h-full m-0 w-1/2">
                    ...
                    <button className='hover:opacity-85 2xl:w-1/4 md:w-44 2xl:h-12 sm:h-8 font-bold md:mt-12 2xl:mt-8 sm:w-3/4 bg-primary-yellow rounded-2xl text-text-black mt-8 cursor-pointer'>Reserve a table</button>
                </div>
