    ...
    return (
            <section className='flex 2xl:px-56 sm:px-12 h-96 text-white bg-primary-green'>
                <div className="h-full m-0 w-1/2">
                    <h1 className='text-primary-yellow font-serif md:font-bold mt-10 2xl:text-5xl md:text-4xl sm:text-2xl'>Little Lemon</h1>
                    <h3 className='mt-2 2xl:text-2xl sm:text-lg font-medium'>Chicago</h3>
                    <p className='2xl:w-3/4 2xl:text-lg sm:w-full 2xl:text-md sm:text-sm mt-6'>
                ...
                <div className="w-1/2 m-0 h-full flex justify-end items-center">
                    <img className="2xl:mt-44 sm:mt-28 2xl:h-[28em] 2xl:w-2/2 md:w-96 sm:w-52 object-cover rounded-lg" src={dish} alt="main"/>
                </div>
            </section>
    );
}
