...
function Reservation() {
    ...
    return (
        <div className="h-[40em] flex flex-col justify-center items-center relative">
            ...
            <h1 className="text-4xl my-20 text-primary-green font-bold">Reserve a table</h1>

            <form className="flex flex-col w-80" onSubmit={hanldeForm}>
                <label htmlFor="res-date" className="text-lg text-gray-700">Choose date:</label>
                <input
                    required
                    type="date"
                    id="res-date"
                ...
                />
                <label htmlFor="res-time" className="text-lg mt-6 text-gray-700">Choose time:</label>
                <select
                    id="res-time"
                    value={time}
                ...
                <input
                     className="mt-10 disabled:opacity-20 disabled:cursor-not-allowed text-lg cursor-pointer p-2 rounded-xl bg-primary-yellow" type="submit" value="Make Your reservation" 
                />
            </form>
        </div>
    );
