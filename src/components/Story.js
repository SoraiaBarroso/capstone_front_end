...
function Story() {
    return(
        <section className="px-6 flex-col lg:mb-10 2xl:px-56 2xl:mt-80 mt-36 lg:mt-56 sm:mt-40 flex lg:flex-row lg:h-[30em] 2xl:h-[35em] sm:flex-col sm:justify-center sm:items-center" id='about'>
