...
function NavBar() {
    ...
    return (
        <nav className='flex justify-between items-center px-6 lg:px-20 2xl:px-56 sm:px-8 lg:h-20 h-24 border-b-2 border-primary-green'>
            <Link to="/">
